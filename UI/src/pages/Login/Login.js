    ...
    <div className='px-8 w-full lg:w-[70%]'>
      ...
      <div className='pt-4'>
        <form onSubmit={onSubmit}>
          <input type="text" name='userName' value={values?.userName} onChange={handleOnChange} placeholder='Email address' className='h-[48px] w-full border p-2 border-gray-400' required/>
